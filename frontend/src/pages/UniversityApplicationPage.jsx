        ...
        <div className="container application-layout">
          <aside className="application-intro">
            ...
            <div className="process-card">
              ...
              <div><span><CreditCard size={18} /></span><p><strong>2. Activez l’abonnement annuel</strong><small>Un tarif unique de 10 $ pour 365 jours.</small></p></div>
