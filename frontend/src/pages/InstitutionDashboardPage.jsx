import { BadgeCheck, BookOpen, BriefcaseBusiness, Building2, Clock3, FileText, GraduationCap, MapPin, School, Users, Wrench } from 'lucide-react';
...
export function InstitutionDashboardPage() {
  ...
  const counts = [
    { label: isSchool ? 'Options actives' : 'Filières actives', value: universite.filieres?.length || universite.nombre_filieres || 0, icon: GraduationCap, tone: 'blue', href: '/espace-universite/formations' },
    { label: isSchool ? 'Services scolaires' : 'Services', value: universite.services?.length || 0, icon: Wrench, tone: 'teal', href: '/espace-universite/services' },
    ...
    { label: isSchool ? 'Élèves liés' : 'Étudiants liés', value: universite.nombre_etudiants || 0, icon: Users, tone: 'violet', href: '/espace-universite/fiche' },
  ];
