...
function Empty() { return <div className="management-empty"><GraduationCap /><h3>Aucune filière</h3><p>Ajoutez la première filière de cette faculté.</p></div>; }
