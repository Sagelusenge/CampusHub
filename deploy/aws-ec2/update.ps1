...
for migration in 26_abonnement_annuel_unique.sql 27_campushub_ia_locale.sql 28_essai_gratuit_30_jours.sql 29_formules_annuelle_et_vie.sql 30_gestion_administrative_utilisateurs.sql; do
